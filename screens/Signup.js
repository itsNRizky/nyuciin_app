          ...
          <View className='bg-white rounded-t-[20px] mt-8 px-8 h-full'>
            ...
            <View className='mt-4'>
              ...
              <TouchableOpacity className='bg-[#2A7DFF] rounded-md mt-5'>
                <Text style={{fontFamily: 'Poppins_500Medium'}} className='text-center text-white my-3 active:opacity-50' onPress={() => navigation.navigate('Signin')}>Daftar</Text>
              </TouchableOpacity>
            </View>
            <Text style={{fontFamily: 'Poppins_500Medium'}} className='text-center text-[#102D5B] mt-3'>Sudah punya akun? <Text className='underline' onPress={() => navigation.navigate('Signin')}>Masuk</Text></Text>
          </View>
        </View>
      </SafeAreaView>
      </ScrollView>
